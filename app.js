/******/ (() => {
  ...
  /******/
  /************************************************************************/
  var __webpack_exports__ = {}; // CONCATENATED MODULE: ./src/images/GitHub-Mark.png

  const GitHub_Mark_namespaceObject =
    __webpack_require__.p + "images/img_b039b2d83982c8256af3.png"; // CONCATENATED MODULE: ./src/modules/tasks.js
  const tasksHandler = {
    items: [],
  ...
  const walking_outside_namespaceObject =
    __webpack_require__.p + "images/img_976e8450074fa4ae177b.png"; // CONCATENATED MODULE: ./src/modules/ui/ui-tasks.js
    ...
    if (projectsHandler.items === null || tasksHandler.items === null) {
      ...
      const testTasksData = [
        ...
        task(
          ...
          "Don't forsdcsdcsds this week ends!",
          new Date("2022-09-13 00:00"),
          "medium",
          0
        ),
        ...
        task(
          ...
          "Tasdasdasdt corner '+ New Project'",
